...
#ifdef ENABLE_ROS
            kinect_ros[serial]->send_raw_images(serial, img_color, img_ir, img_depth);
#endif
...
#ifdef ENABLE_ROS
            kinect_ros[serial]->send_processed_images(serial, img_registered, img_undistorted);
#endif

            cv::flip(img_undistorted, img_undistorted, 1);
