...
public:
    ...
    void send_raw_images(std::string serial, cv::Mat img_color, cv::Mat img_ir, cv::Mat img_depth);
    void send_processed_images(std::string serial, cv::Mat img_registered, cv::Mat img_undistorted);
